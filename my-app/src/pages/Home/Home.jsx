                        ...
                        <div className="recent-active dot-style d-flex dot-style">
                            ...
                            <div className="single-recent">
                                ...
                                <div className="what-cap">
                                    ...
                                    <p>Jun 19, 2020</p>
                                    <a className="popup-video btn-icon" href="https://www.youtube.com/watch?v=1aP-TXUpNoU"><span className="flaticon-play-button"></span></a>
                            ...
                            <div className="single-recent">
                                ...
                                <div className="what-cap">
                                    ...
                                    <p>Jun 19, 2020</p>
                                    <a className="popup-video" href="https://www.youtube.com/watch?v=1aP-TXUpNoU"><span className="flaticon-play-button"></span></a>
                                </div>
                            </div>
