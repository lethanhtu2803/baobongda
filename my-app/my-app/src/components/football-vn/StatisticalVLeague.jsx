...
const StatisticalVLeague = () => {
    const iframeRef = useRef(null);
    const [url, setUrl] = useState();
    const [content, setContent] = useState('');
    const [error, setError] = useState(null);
    const navigate = useNavigate();
    const baobongda24h = `https://bongda24h.vn/bang-xep-hang/top-ghi-ban-vleague-vua-pha-luoi-bong-da-viet-nam-436-248074.html`;
...
export default StatisticalVLeague;
